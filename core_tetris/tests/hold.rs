use core_tetris::{TetrisPlayer, TetrisResult, TetrominoKind, TetrisCommand, MockRng, BagType, TetrominoMove};

#[test]
fn hold_resets() -> TetrisResult {
    let rng = &mut MockRng::tetromino_cycle(&[TetrominoKind::I, TetrominoKind::T, TetrominoKind::T]);
    ...
    assert!(player.hold_queue().as_ref().is_some_and(|tetromino| tetromino.kind() == TetrominoKind::I));
    ...
    assert!(player.hold_queue().as_ref().is_some_and(|tetromino| tetromino.kind() == TetrominoKind::T));
...
fn hold_remembers() -> TetrisResult {
    let start_rng = &mut MockRng::tetromino_cycle(&[TetrominoKind::I, TetrominoKind::T, TetrominoKind::T, TetrominoKind::T, TetrominoKind::T, TetrominoKind::T]);
