...
pub(super) const GRID_BG_COLOR: graphics::types::Color = [0.3, 0.3, 0.3, 1.0];
pub(super) const GRID_COLOR: graphics::types::Color = [0.8, 0.8, 0.8, 1.0];

pub const BLOCK_SIZE: f64 = 25.0 * SCALE_FACTOR;
pub(super) const TETROMINO_MAX_WIDTH: f64 = 4.0 * BLOCK_SIZE;
pub(super) const TETROMINO_MAX_HEIGHT: f64 = 2.0 * BLOCK_SIZE;
pub(super) const GRID_THICKNESS: f64 = 0.5;
