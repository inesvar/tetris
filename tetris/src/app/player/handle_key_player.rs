...
impl LocalPlayer {
    ...
    fn move_active_tetromino(&mut self, keybindings: &Keybindings) -> TetrisResult {
            ...
            .was_just_pressed(&keybindings.rotate_clockwise_keys)
        {
            ...
            self.player_screen
                .active_tetromino
                .try_apply(TetrominoMove::Clockwise, &self.player_screen.grid);
        }
            ...
            .was_just_pressed(&keybindings.rotate_counterclockwise_keys)
        {
            ...
            self.player_screen
                .active_tetromino
                .try_apply(TetrominoMove::Counterclockwise, &self.player_screen.grid);
        }
            ...
            .was_just_pressed(&keybindings.rotate_half_turn_keys)
        {
            ...
            self.player_screen
                .active_tetromino
                .try_apply(TetrominoMove::HalfTurn, &self.player_screen.grid);
        }
